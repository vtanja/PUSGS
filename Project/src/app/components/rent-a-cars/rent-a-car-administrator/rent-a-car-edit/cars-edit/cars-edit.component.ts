...
export class CarsEditComponent implements OnInit {
  ...
  constructor(private carService:CarService, private carAdapter:CarAdapter,
    ...
    private calendar: NgbCalendar,private spinner: NgxSpinnerService,private discountDateService:DiscountDateService) {
  ...
  private getDismissReason(reason: any): string {
   ...
   changePrice():void{
    ...
    this.spinner.show();
    this.carService.changeCarPrice(this.currentCar.id,this.currentCar).subscribe(
      (res:any) => {
        this.spinner.hide();
        Swal.fire({
